...
class AstrologicalSubject:
    ...
    def _planets_degrees_lister(self):
        ...
        midpoint_deg = (sun_deg + moon_deg) / 2
    ...
    def _planets(self) -> None:
        ...
        self.midpoint = calculate_position(self.planets_degrees_ut[13], "Midpoint", point_type=point_type)
    ...
    def _planets_in_houses(self) -> None:
        ...
        self.midpoint = for_every_planet(self.midpoint, self.planets_degrees_ut[13])
