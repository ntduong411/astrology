...
SUN_FORTH_HOUSE_REL = Planet_House_Rel(SUN, FORTH_HOUSE)
SUN_FIFTH_HOUSE_REL = Planet_House_Rel(SUN, FIFTH_HOUSE)
SUN_SEVENTH_HOUSE_REL = Planet_House_Rel(SUN, SEVENTH_HOUSE)
SUN_EIGHTH_HOUSE_REL = Planet_House_Rel(SUN, EIGHTH_HOUSE)
SUN_ELEVENTH_HOUSE_REL = Planet_House_Rel(SUN, ELEVENTH_HOUSE)
SUN_TWELFTH_HOUSE_REL = Planet_House_Rel(SUN, TWELFTH_HOUSE)
MOON_FIRST_HOUSE_REL = Planet_House_Rel(MOON, FIRST_HOUSE)
MOON_FORTH_HOUSE_REL = Planet_House_Rel(MOON, FORTH_HOUSE)
MOON_FIFTH_HOUSE_REL = Planet_House_Rel(MOON, FIFTH_HOUSE)
MOON_SEVENTH_HOUSE_REL = Planet_House_Rel(MOON, SEVENTH_HOUSE)
MOON_ELVENTH_HOUSE_REL = Planet_House_Rel(MOON, ELEVENTH_HOUSE)
MOON_TWELFTH_HOUSE_REL = Planet_House_Rel(MOON, TWELFTH_HOUSE)
MERCURY_SEVENTH_HOUSE_REL = Planet_House_Rel(MERCURY, SEVENTH_HOUSE)
MERCURY_ELVENTH_HOUSE_REL = Planet_House_Rel(MERCURY, ELEVENTH_HOUSE)
VENUS_FIFTH_HOUSE_REL = Planet_House_Rel(VENUS, FIFTH_HOUSE)
VENUS_SEVENTH_HOUSE_REL = Planet_House_Rel(VENUS, SEVENTH_HOUSE)
VENUS_EIGHTH_HOUSE_REL = Planet_House_Rel(VENUS, EIGHTH_HOUSE)
VENUS_ELVENTH_HOUSE_REL = Planet_House_Rel(VENUS, ELEVENTH_HOUSE)
VENUS_TWELFTH_HOUSE_REL = Planet_House_Rel(VENUS, TWELFTH_HOUSE)
